...
<body onunload="opener.location=('../maintenanceNotification.php?maintenanceType=FRE')">

<center>
<form method='post' action='freightMaintenance.php'>
<table width="95%" cellpadding='0' cellspacing='0'>
<tr><td>&nbsp;</td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td colspan='2' class='titleBig'>Freight Contacts Maintenance</td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td>&nbsp;</td></tr>
<?
...
//lp0054_Ad---------ID---ContactID--stockroom-- Name -----------------
...
<?
    ...
    <tr><td>&nbsp;</td></tr>
    <tr><td>&nbsp;</td></tr>
    <tr><td class='bold'>Freight Contact have been updated</td></tr>
    ...
    if( $countRecords > 0 ){  //limit keept for posible future use
        
        ?><tr><td>&nbsp;</td></tr>
        <tr><td>&nbsp;</td></tr>
        <tr><td class='title'>Stockroom already exists</td></tr>
        ...
        ?><tr><td>&nbsp;</td></tr>
        <tr><td>&nbsp;</td></tr>
        <tr><td class='title'>You Must Enter a Stockroom</td></tr>
        <tr><td class='center'><input type='button' onclick="javascript:history.go(-1)" value="Back"></input></td></tr>
        <?
        ...
        $insertSql .= $next_id . ",0,0,'FRE', '$regionName','','','', $responsible )";
        ...
        <tr><td>&nbsp;</td></tr>
        <tr><td>&nbsp;</td></tr>
        <tr><td class='title'>Freight Contact has been added</td></tr>
        ...
        <tr><td>&nbsp;</td></tr>
        <tr><td>&nbsp;</td></tr>
        <tr><td class='title'>FreightContact has been Deleted</td></tr>
        <tr><td class='center'><input type='button' onclick="opener.location=('../maintenanceNotification.php?maintenanceType=FRE');closeW()" value="Close Window"></input></td></tr>
        <?
}
?>
    </table>
